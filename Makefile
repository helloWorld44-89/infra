...
.PHONY: deploy-k8s deploy-vault deploy-docker deploy-agents
...
# ── Ansible playbooks ─────────────────────────────────────────────────────────
## ── Ansible
.PHONY: ansible-k8s ansible-docker ansible-proxmox ansible-vault ansible-monitoring ansible-dev ansible-keyshift ansible-agents
